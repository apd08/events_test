...
// import SuperAdminHeader from '../admin_components/SuperAdminHeader';
  ...
  return (
     ...
     <form className="form" onSubmit={handleSubmit}>
      ...
      <Typography variant='body1' marginBottom={3} fontFamily='Popins' textAlign='center'>Введите ваш email и пароль</Typography>
       ...
       <Button type='submit' sx={{fontFamily:'Popins', marginTop:2, width: '60%', marginBottom:2}} variant="contained"><Link to="admin" className='registr'>Войти</Link></Button>
